...
int SampleDetector::init() {
    char *namesFile = "/usr/local/ev_sdk/config/coco.names";
    char *modelCfgStr = "/usr/local/ev_sdk/model/yolov3-tiny.cfg";
    char *weightsFile = "/usr/local/ev_sdk/model/yolov3-tiny.weight";
    ...
    if (mLabels == nullptr) {
        ...
        return SampleDetector::ERROR_INIT;
    }
    ...
    mNetworkPtr = load_network(modelCfgStr, weightsFile, 0);
